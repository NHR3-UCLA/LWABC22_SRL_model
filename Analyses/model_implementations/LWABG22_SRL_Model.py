...
def LavrentiadisWangAbrahamsonBozorgniaGoulet2022SurfRupLenPref(mag, wrup_max, sof='Strike-Slip', eps=0):
    '''
...
def LavrentiadisWangAbrahamsonBozorgniaGoulet2022SurfRupLenAlt(mag, wrup_max, sof='Strike-Slip', eps=0):
    '''
    Lavrentiadis, Wang,  Abrahamson, Bozorgnia, and Goulet (2022)
    Alternative Surface Rupture Length Model
